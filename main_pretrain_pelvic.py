...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='convmae_convvit_small_patch16', type=str, metavar='MODEL',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/chenxu/datasets/pelvic/h5_data_nonrigid/', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--modality', default='ct', choices=["ct", "cbct"], help='resume from checkpoint')
...
def main(args):
    ...
    # define the model
    model = models_convmae.__dict__[args.model](in_chans=args.n_slices, clamp_out=True, norm_pix_loss=args.norm_pix_loss)
